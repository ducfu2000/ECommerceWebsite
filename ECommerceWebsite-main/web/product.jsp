                        ...
                        <div class="side-bar p-sm-4 p-3">
                            <div class="search-hotel border-bottom py-2">
                                ...
                                <div class="left-side py-2">
                                    <ul>
                                        <li>
                                            <input type="checkbox" class="checked" name="brand" value="msi" onclick="searchProductByBrand(brand.value)">
                                            <span class="span">MSI</span>
                                        </li>
                                        <li>
                                            <input type="checkbox" class="checked" value="msi" onclick="searchProductByBrand(brand.value)">

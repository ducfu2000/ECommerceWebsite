...
<%-- 
    ...
    Created on : Mar 9, 2021, 9:35:27 PM
    Author     : ADMIN
--%>
            ...
            <div class="banner-bootom-w3-agileits py-5">
                <div class="container py-xl-4 py-lg-2">
                                    ...
                                    <c:forEach var="o" items="${image}">
                                        <li data-thumb="${o}">
                                            <div class="thumb-image">
                                                <img src="${o}" data-imagezoom="true" class="img-fluid" alt=""> </div>
                                        </li>
                                    </c:forEach>
                                </ul>
                    ...
                    <div class="col-lg-7 single-right-left simpleCart_shelfItem">
                        ...
                        <p class="mb-3">
                            <span class="item_price">$${product.priceKMVND}</span>
                            <del class="mx-2 font-weight-light">$${product.priceVND}</del>

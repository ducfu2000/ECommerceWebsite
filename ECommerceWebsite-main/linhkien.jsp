                    ...
                    <div class="agileinfo-ads-display col-lg-9">
                        <div class="wrapper">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <c:if test="${tag>1}">
                                        <li class="page-item "><a class="page-link" href="linhkien?page=${tag-1}">Previous</a></li>
                                        </c:if>
                                        <c:forEach var="i" begin="1" end="${endPage}">
                                        <li class="page-item ${tag==i?"active":""}"><a class="page-link" href="linhkien?page=${i}">${i}</a></li>
                                        </c:forEach>
                                        <c:if test="${tag<endPage}">
                                        <li class="page-item"><a class="page-link" href="linhkien?page=${tag+1}">Next</a></li>
                                        </c:if>
                                </ul>
                            </nav>
                            <!-- first section -->
                    ...
                    <div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
                        <div class="side-bar p-sm-4 p-3">
                            <div class="search-hotel border-bottom py-2">
                                <h3 class="agileits-sear-head mb-3">Linh kiện</h3>
                                <div class="left-side py-2">
                                    <ul>
                                        <jsp:useBean id="dal" scope="page" class="dal.DAO" />
                                        <c:forEach var="o" items="${dal.allTypeLinhKien}">
                                            <li>
                                                <input ${o.name==brand?"checked":""} onclick='window.location.assign("/ProjectQLBH/ViewLinhKienByTypeServlet?brand=${o.name}")' type="checkbox" class="checked" name="brand" value="${o.name}">
